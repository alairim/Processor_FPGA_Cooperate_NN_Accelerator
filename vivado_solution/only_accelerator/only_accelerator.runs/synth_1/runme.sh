...
HD_PWD='C:/ASPLC_Projects/only_accelerator/only_accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerator_2049_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerator_2049_v1_0.tcl
