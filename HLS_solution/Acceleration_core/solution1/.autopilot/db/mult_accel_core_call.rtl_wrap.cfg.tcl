...
set structArgument0 [list 32 4 5 5 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<32, 4, 5, 5>" "struct ap_axiu" $structMem0 0 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
