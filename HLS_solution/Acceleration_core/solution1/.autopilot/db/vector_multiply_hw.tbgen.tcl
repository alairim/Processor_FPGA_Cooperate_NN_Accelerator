set moduleName vector_multiply_hw
...
set C_modelName {vector_multiply_hw}
set C_modelType { float 32 }
set C_modelArgList {
	{ a float 32 regular {array 784 { 1 3 } 1 1 }  }
	{ b float 32 regular {array 784 { 1 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mult_accel_core_cbkb_U8", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mult_accel_core_ccud_U9", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8625", "Max" : "8625"}
	, {"Name" : "Interval", "Min" : "8625", "Max" : "8625"}
]}
