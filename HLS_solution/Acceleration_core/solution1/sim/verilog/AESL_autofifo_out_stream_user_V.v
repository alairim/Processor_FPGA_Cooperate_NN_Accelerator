...
module AESL_autofifo_out_stream_user_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.mult_accel_core_call.autotvin_out_stream_user_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.mult_accel_core_call.autotvout_out_stream_user_V.dat";
