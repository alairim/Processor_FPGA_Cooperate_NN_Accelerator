...
if {[file isfile mult_accel_core_call.autotvin.dat]} {
	file delete -force mult_accel_core_call.autotvin.dat
}

if {[file isfile mult_accel_core_call.autotvout.dat]} {
	file delete -force mult_accel_core_call.autotvout.dat
}
