...
// ==============================================================
#ifndef __mult_accel_core_ccud__HH__
#define __mult_accel_core_ccud__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mult_accel_core_ccud) {
    ...
    SC_CTOR(mult_accel_core_ccud):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
