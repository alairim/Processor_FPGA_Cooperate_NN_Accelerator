...
// ==============================================================
#ifndef __mult_accel_core_cbkb__HH__
#define __mult_accel_core_cbkb__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mult_accel_core_cbkb) {
    ...
    SC_CTOR(mult_accel_core_cbkb):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
