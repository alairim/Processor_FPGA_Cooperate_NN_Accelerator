...
HD_PWD='C:/Users/AlaiC/Desktop/project_test/project_test.runs/design_1_mult_accel_core_call_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mult_accel_core_call_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mult_accel_core_call_0_0.tcl
