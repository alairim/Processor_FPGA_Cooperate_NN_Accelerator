...
proc create_root_design { parentCell } {
  ...
  # Create instance: mult_accel_core_call_0, and set properties
  set mult_accel_core_call_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mult_accel_core_call:1.0 mult_accel_core_call_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mult_accel_core_call_0/INPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net mult_accel_core_call_0_OUTPUT_STREAM [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins mult_accel_core_call_0/OUTPUT_STREAM]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mult_accel_core_call_0/S_AXI_CONTROL_BUS/Reg] SEG_mult_accel_core_call_0_Reg
